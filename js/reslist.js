function showList(No,String,Label1,Hits,Label2,Corpus,Max,atttype,player, cgiRoot, concordance_for_speech, struct_display) {
    ...
    concordance_for_speech = "&concordance_for_speech=" +concordance_for_speech;
	  ...
	  for (var i = 1;i<=No;i++) {
            ...
            +"&query_id="+String+"&corpus="+Corpus+atttype+player+concordance_for_speech+'&structDisplay='+struct_display+"\"> "+i+"</a> ";
