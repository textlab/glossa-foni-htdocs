var Menu;
function reloadMenuSubtitles_no() {
Menu['SUBTITLES_NO'] = new Hash(     1, new Hash(
       ...
       1, new Hash(
	    ...
	    5, new Hash(
         'contents', 'infinitive marker',
	      'type', 'js',
	      'uri', "addOpt('pos','infmark','infinitive marker')"
,
       1, new Hash(
            'contents', 'velg',
	         'type', 'js',
       ...
       1, new Hash(
	    ...
	    11, new Hash(
         'contents', 'subjunction',
	      'type', 'js',
	      'uri', "addOpt('pos','subj','subjunction')"
,
       1, new Hash(
            'contents', 'velg',
	         'type', 'js',
...
,
       1, new Hash(
	    ...
	    3, new Hash(
         'contents', 'proper name',
	      'type', 'js',
	      'uri', "addOpt('type','p','proper name')"
,
       1, new Hash(
            'contents', 'velg',
	         'type', 'js',
