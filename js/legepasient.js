var Menu;
function reloadMenuLegepasient() {
    Menu['LEGEPASIENT'] =
        new Hash(
			     ...
			     17, new Hash(
					  'contents', 'comments',
                                          1, new Hash(
                                                       'contents', 'full-text',
                                                       'type', 'js',
                                                       'uri', "addOpt('cmt','word','cmt-full-text')"
                                                       ),
                                          2, new Hash(
                                                      'contents', 'fornavn',
                                                      'type', 'js',
                                                      'uri', "addOpt('word', '\(.*fornavn.*\)', 'fornavn')",
                                                      1, new Hash(
                                                                  'contents', 'exclude',
                                                                  'type', 'js',
                                                                  'uri', "addOpt('word', '!\(.*fornavn.*\)', '!fornavn')"
                                          ...
                                          3, new Hash(
                                                      'contents', 'fremre klikkelyd',
                                                      'type', 'js',
                                                      'uri', "addOpt('word', '\(.*fremre@@@klikkelyd.*\)', 'fremre klikkelyd')",
                                                      1, new Hash(
                                                                  'contents', 'exclude',
                                                                  'type', 'js',
                                                                  'uri', "addOpt('word', '!\(.*fremre@@@klikkelyd.*\)', '!fremre@@@klikkelyd')"
                                          ...
                                          4, new Hash(
                                                      'contents', 'hosting',
                                                      'type', 'js',
                                                      'uri', "addOpt('word', '\(.*hosting.*\)', 'hosting')",
                                                      1, new Hash(
                                                                  'contents', 'exclude',
                                                                  'type', 'js',
                                                                  'uri', "addOpt('word', '!\(.*hosting.*\)', '!hosting')"
                                          ...
                                          6, new Hash(
                                                      'contents', 'hviskende',
                                                      'type', 'js',
                                                      'uri', "addOpt('word', '\(.*hviskende.*\)', 'hviskende')",
                                                      1, new Hash(
                                                                  'contents', 'exclude',
                                                                  'type', 'js',
                                                                  'uri', "addOpt('word', '!\(.*hviskende.*\)', '!hviskende')"
                                          ...
                                          7, new Hash(
                                                      'contents', 'kremting',
                                                      'type', 'js',
                                                      'uri', "addOpt('word', '\(.*kremting.*\)', 'kremting')",
                                                      1, new Hash(
                                                                  'contents', 'exclude',
                                                                  'type', 'js',
                                                                  'uri', "addOpt('word', '!\(.*kremting.*\)', '!kremting')"
                                          ...
                                          8, new Hash(
                                                      'contents', 'lang pause',
                                                      'type', 'js',
                                                      'uri', "addOpt('word', '\(.*lang@@@pause.*\)', 'lang pause')",
                                                      1, new Hash(
                                                                  'contents', 'exclude',
                                                                  'type', 'js',
                                                                  'uri', "addOpt('word', '!\(.*lang@@@pause.*\)', '!lang@@@pause')"
                                          ...
                                          10, new Hash(
                                                      'contents', 'lattermild',
                                                      'type', 'js',
                                                      'uri', "addOpt('word', '\(.*lattermild.*\)', 'lattermild')",
                                                      1, new Hash(
                                                                  'contents', 'exclude',
                                                                  'type', 'js',
                                                                  'uri', "addOpt('word', '!\(.*lattermild.*\)', '!lattermild')"
                                          ...
                                          12, new Hash(
                                                      'contents', 'noterer',
                                                      'type', 'js',
                                                      'uri', "addOpt('word', '\(.*noterer.*\)', 'noterer')",
                                                      1, new Hash(
                                                                  'contents', 'exclude',
                                                                  'type', 'js',
                                                                  'uri', "addOpt('word', '!\(.*noterer.*\)', '!noterer')"
                                          ...
                                          13, new Hash(
                                                      'contents', 'lyder fra apparatet',
                                                      'type', 'js',
                                                      'uri', "addOpt('word', '\(.*lyder@@@fra@@@apparatet.*\)', 'lyder fra apparatet')",
                                                      1, new Hash(
                                                                  'contents', 'exclude',
                                                                  'type', 'js',
                                                                  'uri', "addOpt('word', '!\(.*lyder@@@fra@@@apparatet.*\)', '!lyder@@@fra@@@apparatet')"
                                          ...
                                          17, new Hash(
                                                      'contents', 'pipelyd',
                                                      'type', 'js',
                                                      'uri', "addOpt('word', '\(.*pipelyd.*\)', 'pipelyd')",
                                                      1, new Hash(
                                                                  'contents', 'exclude',
                                                                  'type', 'js',
                                                                  'uri', "addOpt('word', '!\(.*pipelyd.*\)', '!pipelyd')"
                                          ...
                                          18, new Hash(
                                                      'contents', 'pusting',
                                                      'type', 'js',
                                                      'uri', "addOpt('word', '\(.*pusting.*\)', 'pusting')",
                                                      1, new Hash(
                                                                  'contents', 'exclude',
                                                                  'type', 'js',
                                                                  'uri', "addOpt('word', '!\(.*pusting.*\)', '!pusting')"
                                          ...
                                          19, new Hash(
                                                      'contents', 'reiser seg',
                                                      'type', 'js',
                                                      'uri', "addOpt('word', '\(.*reiser@@@seg.*\)', 'reiser seg')",
                                                      1, new Hash(
                                                                  'contents', 'exclude',
                                                                  'type', 'js',
                                                                  'uri', "addOpt('word', '!\(.*reiser@@@seg.*\)', '!reiser@@@seg')"
                                          ...
                                          20, new Hash(
                                                      'contents', 'rekker frem hånden',
                                                      'type', 'js',
                                                      'uri', "addOpt('word', '\(.*rekker@@@frem@@@hånden.*\)', 'rekker frem hånden')",
                                                      1, new Hash(
                                                                  'contents', 'exclude',
                                                                  'type', 'js',
                                                                  'uri', "addOpt('word', '!\(.*rekker@@@frem@@@hånden.*\)', '!rekker@@@frem@@@hånden')"
                                          ...
                                          21, new Hash(
                                                      'contents', 'ser på dataskjermen',
                                                      'type', 'js',
                                                      'uri', "addOpt('word', '\(.*ser@@@på@@@dataskjermen.*\)', 'ser på dataskjermen')",
                                                      1, new Hash(
                                                                  'contents', 'exclude',
                                                                  'type', 'js',
                                                                  'uri', "addOpt('word', '!\(.*ser@@@på@@@dataskjermen.*\)', '!ser@@@på@@@dataskjermen')"
                                          ...
                                          22, new Hash(
                                                      'contents', 'ser på skjermen',
                                                      'type', 'js',
                                                      'uri', "addOpt('word', '\(.*ser@@@på@@@skjermen.*\)', 'ser på skjermen')",
                                                      1, new Hash(
                                                                  'contents', 'exclude',
                                                                  'type', 'js',
                                                                  'uri', "addOpt('word', '!\(.*ser@@@på@@@skjermen.*\)', '!ser@@@på@@@skjermen')"
                                          ...
                                          23, new Hash(
                                                      'contents', 'setter seg',
                                                      'type', 'js',
                                                      'uri', "addOpt('word', '\(.*setter@@@seg.*\)', 'setter seg')",
                                                      1, new Hash(
                                                                  'contents', 'exclude',
                                                                  'type', 'js',
                                                                  'uri', "addOpt('word', '!\(.*setter@@@seg.*\)', '!setter@@@seg')"
                                          ...
                                          25, new Hash(
                                                      'contents', 'snufsing',
                                                      'type', 'js',
                                                      'uri', "addOpt('word', '\(.*snufsing.*\)', 'snufsing')",
                                                      1, new Hash(
                                                                  'contents', 'exclude',
                                                                  'type', 'js',
                                                                  'uri', "addOpt('word', '!\(.*snufsing.*\)', '!snufsing')"
                                          ...
                                          26, new Hash(
                                                      'contents', 'snur seg mot dataskjermen',
                                                      'type', 'js',
                                                      'uri', "addOpt('word', '\(.*snur@@@seg@@@mot@@@dataskjermen.*\)', 'snur seg mot dataskjermen')",
                                                      1, new Hash(
                                                                  'contents', 'exclude',
                                                                  'type', 'js',
                                                                  'uri', "addOpt('word', '!\(.*snur@@@seg@@@mot@@@dataskjermen.*\)', '!snur@@@seg@@@mot@@@dataskjermen')"
                                          ...
                                          28, new Hash(
                                                      'contents', 'stedsnavn',
                                                      'type', 'js',
                                                      'uri', "addOpt('word', '\(.*stedsnavn.*\)', 'stedsnavn')",
                                                      1, new Hash(
                                                                  'contents', 'exclude',
                                                                  'type', 'js',
                                                                  'uri', "addOpt('word', '!\(.*stedsnavn.*\)', '!stedsnavn')"
                                          ...
                                          29, new Hash(
                                                      'contents', 'sukking',
                                                      'type', 'js',
                                                      'uri', "addOpt('word', '\(.*sukking.*\)', 'sukking')",
                                                      1, new Hash(
                                                                  'contents', 'exclude',
                                                                  'type', 'js',
                                                                  'uri', "addOpt('word', '!\(.*sukking.*\)', '!sukking')"
                                          ...
                                          30, new Hash(
                                                      'contents', 'sykehus',
                                                      'type', 'js',
                                                      'uri', "addOpt('word', '\(.*sykehus.*\)', 'sykehus')",
                                                      1, new Hash(
                                                                  'contents', 'exclude',
                                                                  'type', 'js',
                                                                  'uri', "addOpt('word', '!\(.*sykehus.*\)', '!sykehus')"
                                          ...
                                          31, new Hash(
                                                      'contents', 'tar seg til brystet',
                                                      'type', 'js',
                                                      'uri', "addOpt('word', '\(.*tar@@@seg@@@til@@@brystet.*\)', 'tar seg til brystet')",
                                                      1, new Hash(
                                                                  'contents', 'exclude',
                                                                  'type', 'js',
                                                                  'uri', "addOpt('word', '!\(.*tar@@@seg@@@til@@@brystet.*\)', '!tar@@@seg@@@til@@@brystet')"
                                          ...
                                          32, new Hash(
                                                      'contents', 'trekker pusten',
                                                      'type', 'js',
                                                      'uri', "addOpt('word', '\(.*trekker@@@pusten.*\)', 'trekker pusten')",
                                                      1, new Hash(
                                                                  'contents', 'exclude',
                                                                  'type', 'js',
                                                                  'uri', "addOpt('word', '!\(.*trekker@@@pusten.*\)', '!trekker@@@pusten')"
                                          ...
                                          35, new Hash(
                                                      'contents', 'medikamentnavn',
                                                      'type', 'js',
                                                      'uri', "addOpt('descr', 'me:medikamentnavn', 'medikamentnavn')",
                                                      1, new Hash(
                                                                  'contents', 'exclude',
                                                                  'type', 'js',
                                                                  'uri', "addOpt('descr', '!me:medikamentnavn', '!medikamentnavn')"
