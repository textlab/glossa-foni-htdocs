...
function ReloadMenu(language) {
	...
	// FIXME: this should be dynamic ...
       if (language == 'POLITIKK') {
       ...
       else if (language == 'RUN_EN') {
               reloadMenuRun_en();
       }
       else if (language == 'RUN_BG') {
               reloadMenuRun_bg();
       }
       else if (language == 'RUN_BC') {
               reloadMenuRun_bc();
       }
       else if (language == 'RUN_PL') {
               reloadMenuRun_pl();
       }
       else if (language == 'RUN_FR') {
               reloadMenuRun_fr();
       }
       else if (language == 'RUN_IT') {
               reloadMenuRun_it();
       }
       else if (language == 'RUN_SE') {
               reloadMenuRun_se();
       }
       ...
       else if (language == 'MUSIKK') {
               reloadMenuMusikk();
       }
       else if (language == 'MME') {
               reloadMenuMME();
       }
       else if (language == 'QURAN_MONO') {
               reloadMenuQuranMono();
       }
		   else if (language == 'QURAN_ENG') {
               reloadMenuQuranEng();
       }
		else if (language == 'UNCORPORA_AR') {
        reloadMenuUncorporaAR();
    }
		else if (language == 'UNCORPORA_EN') {
        reloadMenuUncorporaEN();
    }
		else if (language == 'UNCORPORA_ES') {
        reloadMenuUncorporaES();
    }
		else if (language == 'UNCORPORA_FR') {
        reloadMenuUncorporaFR();
    }
		else if (language == 'UNCORPORA_RU') {
        reloadMenuUncorporaRU();
    }
		else if (language == 'UNCORPORA_ZH') {
        reloadMenuUncorporaZH();
    }
		else if (language == 'JAPANESE_TEST') {
        reloadMenuJapaneseTest();
    }
		else if (language == 'JAPANESE_S_TEST') {
        reloadMenuJapaneseSTest();
    }
		...
		else if (language == 'LEGEPASIENT') {
        reloadMenuLegepasient();
    }
