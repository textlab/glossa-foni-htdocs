...
function domMenu_resolveLink(in_this, in_event)
{
    var eventObj = domLib_isIE ? event : in_event;
    var currentTarget = domLib_isIE ? in_this : eventObj.currentTarget;
    var basename = currentTarget.data.get('basename'); // eg menu_0_1
    ...
    var uri = currentTarget.data.get('uri'); // eg addOpt('w', 'lemma', 'lemma'); ie, the uri element in the menu hash element selected
