		 ...
		 1, new Hash('contents', '<nobr>criteria&#187;&nbsp;</nobr>',
			     ...
			     4, new Hash(
					 ...
					 2, new Hash(
						     'contents', 'acc_subj',
						     'type', 'js',
						     'uri', "addOpt('case','acc_subj','acc_subj')",
						     1, new Hash(
								 'contents', 'exclude',
								 'type', 'js',
								 'uri', "addOpt('case','!acc_subj','!acc_subj')"
			     ...
			     6, new Hash(
					 ...
					 1, new Hash(
						     'contents', 'back_click',
						     'type', 'js',
						     'uri', "addOpt('nlex','back_click','back_click')",
						     1, new Hash(
								 'contents', 'exclude',
								 'type', 'js',
								 'uri', "addOpt('nlex','!back_click','!back_click')"
					 ...
					 6, new Hash(
						     'contents', 'draws_breath',
						     'type', 'js',
						     'uri', "addOpt('nlex','draws_breath','draws_breath')",
						     1, new Hash(
								 'contents', 'exclude',
								 'type', 'js',
								 'uri', "addOpt('nlex','!draws_breath','!draws_breath')"
					 ...
					 8, new Hash(
						     'contents', 'front_klick',
						     'type', 'js',
						     'uri', "addOpt('nlex','front_klick','front_klick')",
						     1, new Hash(
								 'contents', 'exclude',
								 'type', 'js',
								 'uri', "addOpt('nlex','!front_klick','!front_klick')"
					 ...
					 13, new Hash(
						      'contents', 'labial_fricative',
						      'type', 'js',
						      'uri', "addOpt('nlex','labial_fricative','labial_fricative')",
						      1, new Hash(
								  'contents', 'exclude',
								  'type', 'js',
								  'uri', "addOpt('nlex','!labial_fricative','!labial_fricative')"
			     ...
			     11, new Hash(
					  ...
					  3, new Hash(
						      'contents', 'indef_def',
						      'type', 'js',
						      'uri', "addOpt('defn','indef_def','indef_def')",
						      1, new Hash(
								  'contents', 'exclude',
								  'type', 'js',
								  'uri', "addOpt('defn','!indef_def','!indef_def')"
			     ...
			     14, new Hash(
					  ...
					  15, new Hash(
						       'contents', 'noun_uninflected',
						       'type', 'js',
						       'uri', "addOpt('type','noun_uninflected','noun_uninflected')",
						       1, new Hash(
								   'contents', 'exclude',
								   'type', 'js',
								   'uri', "addOpt('type','!noun_uninflected','!noun_uninflected')"
			     ...
			     16, new Hash(
					  ...
					  4, new Hash(
						      'contents', 'masc_fem',
						      'type', 'js',
						      'uri', "addOpt('gender','masc_fem','masc_fem')",
						      1, new Hash(
								  'contents', 'exclude',
								  'type', 'js',
								  'uri', "addOpt('gender','!masc_fem','!masc_fem')"
					  ...
					  5, new Hash(
						      'contents', 'masc_fem_neut',
						      'type', 'js',
						      'uri', "addOpt('gender','masc_fem_neut','masc_fem_neut')",
						      1, new Hash(
								  'contents', 'exclude',
								  'type', 'js',
								  'uri', "addOpt('gender','!masc_fem_neut','!masc_fem_neut')"
					  ...
					  6, new Hash(
						      'contents', 'masc_neut',
						      'type', 'js',
						      'uri', "addOpt('gender','masc_neut','masc_neut')",
						      1, new Hash(
								  'contents', 'exclude',
								  'type', 'js',
								  'uri', "addOpt('gender','!masc_neut','!masc_neut')"
