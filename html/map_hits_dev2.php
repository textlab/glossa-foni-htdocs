...
<!--  <input type='button' onclick="javascript:clearMap();" value='clear all' /> -->
  ...
  <div id="legend" style="position: absolute; top: 30px; left: 670px; background-color: #6ac; width: 200px; height: 540px;">
  </div>
  <div id="legend2" style="position: absolute; top: 30px; left: 890px; background-color: #6a0; width: 200px; height: 540px;">
  </div>
