...
if($corpus == "bigbrother"){$corpus = "BB";}
$movie_loc .= "$corpus/$fn";
  ...
  <head>
   ...
   <script type='text/javascript'>
	...
	function expand(dir, n){
	  ...
	  document.location = 'media3.php?corpus='+corpus+'&line_key='+id+'&left='+left+'&right='+right+'&video='+video;
	}
	function setSelect(){
...
function filename( $file, $vid, $corp ){
    if($corp == 'engl2'){ return "audio/" . $file . ".MOV"; }
    $pat = "/^[A-Z]*_/";
